...
public class SwaggerConfigServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp)
                ...
                // ==========================================
                String sendOtpPath = "\"/api/register/send-otp\":{"
                                + "\"post\":{"
                ...
                // ============================================
                String verifyOtpPath = "\"/api/register/verify-otp\":{"
                                + "\"post\":{"
                ...
                // =============================================
                String resendOtpPath = "\"/api/register/resend-otp\":{"
                                + "\"post\":{"
                ...
                String resetPasswordPath = "\"/api/reset-password\":{"
                                + "\"post\":{"
                ...
                String forgotPasswordPath = "\"/api/forgot-password\":{"
                                + "\"post\":{"
                ...
                String eventDetailPath = "\"/api/events/detail\":{"
                                + "\"get\":{"
                ...
                String paymentTicketPath = "\"/api/payment-ticket\":{"
                                + "\"get\":{"
                ...
                // ===== API: /api/buyTicket =====
                String buyTicketPath = "\"/api/buyTicket\":{"
                                + "\"get\":{"
                ...
                String staffCheckinPath = "\"/api/staff/checkin\":{"
                                + "\"post\":{"
                                ...
                                + "}"
                                + "}";
                // ===== API: /api/staff/checkout =====
                String staffCheckoutPath = "\"/api/staff/checkout\":{"
                                + "\"post\":{"
                                + "\"summary\":\"Check-out vé sự kiện (STAFF/ADMIN)\","
                                + "\"description\":\"STAFF dùng ticketId để xác nhận khách ra về (Check-out). Cập nhật checkout_time.\","
                                + "\"security\":[{\"bearerAuth\":[]}],"
                                + "\"parameters\":["
                                + "  {"
                                + "    \"name\":\"ticketId\","
                                ...
                                + "    }"
                                + "  },"
                                + "  \"400\":{\"description\":\"Lỗi (Vé chưa check-in hoặc đã check-out rồi)\"},"
                                + "  \"401\":{\"description\":\"Unauthorized\"},"
                                + "  \"403\":{\"description\":\"Forbidden\"}"
                                + "}"
                                + "}"
                ...
                String eventRequestCreatePath = "\"/api/event-requests\":{"
                                + "\"post\":{"
                ...
                String myEventRequestsPath = "\"/api/event-requests/my\":{"
                                + "\"get\":{"
                ...
                String organizerEventRequestsPath = "\"/api/staff/event-requests\":{"
                                + "\"get\":{"
                ...
                String eventRequestProcessPath = "\"/api/event-requests/process\":{"
                                + "\"post\":{"
                ...
                String freeAreasPath = "\"/api/areas/free\":{"
                                + "\"get\":{"
                ...
                String venueAreasPath = "\"/api/venues/areas\":{"
                                + "\"get\":{"
                ...
                String myTicketsPath = "\"/api/registrations/my-tickets\":{"
                                + "\"get\":{"
                ...
                // ===== API: /api/events/stats (CẬP NHẬT) =====
                String eventStatsPath = "\"/api/events/stats\":{"
                                + "\"get\":{"
                                + "\"summary\":\"[Organizer] Thống kê tham dự (Check-in / Check-out)\","
                                + "\"description\":\"Đếm tổng vé đăng ký, số người đã check-in, check-out và tỷ lệ tương ứng.\","
                                + "\"security\":[{\"bearerAuth\":[]}],"
                                + "\"parameters\":["
                                + "  {"
                                + "    \"name\":\"eventId\","
                                ...
                                + "\"responses\":{"
                                + "  \"200\":{"
                                + "    \"description\":\"Thông tin thống kê chi tiết\","
                                + "    \"content\":{"
                                + "      \"application/json\":{"
                                + "        \"schema\":{"
                                + "          \"type\":\"object\","
                                ...
                                + "            \"totalCheckedIn\":{\"type\":\"integer\", \"example\": 80},"
                                + "            \"totalCheckedOut\":{\"type\":\"integer\", \"example\": 15},"
                                + "            \"checkInRate\":{\"type\":\"string\", \"example\": \"80.0%\"},"
                                + "            \"checkOutRate\":{\"type\":\"string\", \"example\": \"15.0%\"}" // <--- MỚI
                                + "          }"
                                + "        }"
                                + "      }"
                                + "    }"
                ...
                String myBillsPath = "\"/api/payment/my-bills\":{"
                                + "\"get\":{"
                ...
                String updateEventDetailsPath = "\"/api/events/update-details\":{"
                                + "\"post\":{"
