...
public class SwaggerConfigServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        String resetPasswordPath
                = "\"/api/reset-password\":{"
                + "\"post\":{"
                + "\"summary\":\"Reset password bằng token + OTP\","
                + "\"requestBody\":{"
                + "\"required\":true,"
                + "\"content\":{"
                + "\"application/json\":{"
                ...
                + "\"401\":{\"description\":\"Token/OTP không hợp lệ\"},"
        ...
        String forgotPasswordPath
                = "\"/api/forgot-password\":{"
                + "\"post\":{"
                + "\"summary\":\"Gửi OTP và token đặt lại mật khẩu qua email\","
                + "\"requestBody\":{"
                + "\"required\":true,"
                + "\"content\":{"
                + "\"application/json\":{"
                ...
                + "\"responses\":{"
                + "\"200\":{"
                + "\"description\":\"Đã gửi OTP và link đặt lại mật khẩu\","
                + "\"content\":{"
                + "\"application/json\":{"
                + "\"schema\":{\"$ref\":\"#/components/schemas/StatusMessage\"}"
                + "}"
        ...
        String json
                ...
                + seatsPath + ","           
                + eventDetailPath + ","
                + paymentTicketPath + "," // ✅ thêm dòng này
                + buyTicketPath // ✅ và dòng này (không có dấu phẩy phía sau)
                + "},"
                + "\"components\":{"
                ...
                + "},"
                + "\"required\":[\"token\",\"otp\",\"newPassword\"]"
                + "},"
                // User
                + "\"User\":{"
                + "\"type\":\"object\","
