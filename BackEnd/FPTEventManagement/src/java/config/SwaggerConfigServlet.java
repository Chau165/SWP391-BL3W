...
public class SwaggerConfigServlet extends HttpServlet {
        ...
        protected void doGet(HttpServletRequest req, HttpServletResponse resp)
                ...
                String eventStatsPath = "\"/api/events/stats\":{"
                                ...
                                + "Logic: Admin thấy toàn bộ. Organizer chỉ thấy số liệu của sự kiện mình tạo. " // ĐÃ
                                                                                                                 // XÓA
                                                                                                                 // câu:
                                                                                                                 // Có
                                                                                                                 // thể
                ...
                String ticketListPath = "\"/api/tickets/list\":{"
                                ...
                                + "Hệ thống lọc các vé có trạng thái: BOOKED, CHECKED_IN, CHECKED_OUT, REFUNDED.\"," // Cập
                                                                                                                     // nhật
                                                                                                                     // trạng
                                                                                                                     // thái
                                + "\"security\":[{\"bearerAuth\":[]}],"
                                ...
                                + "  }"
                                // Lưu ý: Nếu DAO đã bỏ lọc theo date, bạn nên xóa parameter date ở đây để tránh
                                // làm FE hiểu lầm
                                + "],"
                                + "\"responses\":{"
                                + "  \"200\":{"
                ...
                String staffOrganizerPath = "\"/api/users/staff-organizer\":{"
                                + "\"get\":{"
                                + "\"tags\":[\"Users\"],"
                                ...
                                + "    \"required\":false,"
                                + "    \"schema\":{\"type\":\"integer\"},"
                                + "    \"description\":\"(Optional) Lọc theo user ID. Nếu để trống trả về tất cả staff & organizer.\""
                                + "  }"
                                + "],"
                                + "\"responses\":{"
                                + "  \"200\":{"
                ...
                String json = "{"
                                ...
                                + "\"startTime\":{\"type\":\"string\",\"format\":\"date-time\"},"
                                + "\"status\":{\"type\":\"string\", \"enum\":[\"BOOKED\",\"CHECKED_IN\",\"CHECKED_OUT\",\"REFUNDED\"]}," // Thêm
                                                                                                                                         // REFUNDED
                                + "\"checkInTime\":{\"type\":\"string\",\"format\":\"date-time\"},"
