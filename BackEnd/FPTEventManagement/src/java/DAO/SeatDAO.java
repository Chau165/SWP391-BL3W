...
public class SeatDAO {
    ...
    /**
     * Kiểm tra ghế đã được đặt cho event này chưa
     * Ticket.status: 'BOOKED', 'CHECKED_IN' được xem là đã chiếm ghế
     */
    ...
    /**
     * Lấy toàn bộ ghế theo area.
     * Lưu ý: tham số venueId bây giờ thực chất là areaId (do đổi schema).
     */
    ...
    // ====================== LIST BY AREA + TYPE ======================
    /**
     * Lấy ghế theo area + loại ghế (seat_type: VIP / STANDARD / ...)
     * Tham số venueId thực chất là areaId.
     */
